<template>
  ...
  <div class="page-single-news__content" v-if="data">
    ...
    <div class="news-template__main">
      ...
      <!-- фотогалерея -->
      <ul class="media_container" v-if="data.IMAGES">
        <li class="image" v-for="(file, j) in data.IMAGES" :key="j">
          <img @click="photoClickHandler(file)" :src="file.fileLink" />
        </li>
      </ul>
      ...
      <!-- видео -->
      <ul class="media_container" v-if="data.VIDEOFILE">
        <template v-for="(item, i) in data.VIDEOFILE">
      ...
      <!-- аудио -->
      <ul class="media_container" v-if="data.AUDIOFILE">
        <li class="audio" v-for="(item, i) in data.AUDIOFILE" :key="i">
      ...
      <!-- файлы -->
      <ul class="media_container" v-if="data.FILE">
        <li class="file" v-for="(file, i) in data.FILE" :key="i">
